...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<br />
	Enter values for some of the currents and it will calculate the ones that it can:
	<br />
	Is =
		<asp:TextBox ID="TextBoxS" runat="server" Width="50px"></asp:TextBox>
		A&nbsp;&nbsp;&nbsp;&nbsp;
	<asp:Label ID="LabelS" runat="server"></asp:Label>
	<br />
	I1 =
	...
	<br />
	I5 = <asp:TextBox ID="TextBox5" runat="server" Width="50px"></asp:TextBox>
		A&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<asp:Label ID="Label7" runat="server"></asp:Label>
		<br />
		<br />
		<asp:Button ID="ButtonSubmit" runat="server" Text="Calculate Currents" OnClick="ButtonSubmit_Click" />
	<br />
	<p class="header">&nbsp;</p>

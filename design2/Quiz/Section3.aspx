...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<br />
	<span style="text-decoration: underline">Variables for Q1. and Q2.</span><br />
	Vo =
	...
	<br />
	<br />
	<span style="text-decoration: underline">Variables for Q4. and Q5.</span><br />
	Is =
	<asp:Label ID="lblQ2Is" runat="server"></asp:Label>
	mA<br />
	R1 =
	...
	Ω<br />
	<br />
	Q4. With these new values, what is the current i1 in the above circuit?<asp:Label ID="Label4" runat="server"></asp:Label>
	<br />
	...
	<br />
	<br />
	Q5. What is the current i2 in the above circuit?<asp:Label ID="Label5" runat="server"></asp:Label>
	<br />
	...
	<br />
	<br />
	Q6. What is the current i1 in the above circuit?<asp:Label ID="Label6" runat="server"></asp:Label>
	<br />
	<asp:TextBox ID="TextBox6" runat="server" Width="59px"></asp:TextBox>
	...
	<br />
	<br />
	Q7. What is the current Is in the above circuit?<asp:Label ID="Label7" runat="server"></asp:Label>
	<br />
	...
	<br />
	<br />
	Q8. What is the current i5 in the above circuit?<asp:Label ID="Label8" runat="server"></asp:Label>
	<br />
	...
	<br />
	<br />
	Q9. What is the current i7 in the above circuit?<asp:Label ID="Label9" runat="server"></asp:Label>
	<br />
	<asp:TextBox ID="TextBox9" runat="server" Width="54px"></asp:TextBox>

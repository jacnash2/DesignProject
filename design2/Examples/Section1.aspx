<%@ Page Title="Circuit Variables and Elements: Examples" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Section1.aspx.cs" Inherits="design2.Section1" %>
...
&nbsp;<br />
			...
			&nbsp;<br />
			<br />
			<asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Submit" class="button"/>
			<br />
        </div>
		<br />
		...
		<br />
			...
			<br />
			Answer: 10 V / 2 A = <strong>5 Ω</strong>
</asp:Content>
